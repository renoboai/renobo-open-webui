...
<div
	...
	class="{loading
		...
		: 'bg-renobo-green/10 dark:bg-renobo-green/20 '} rounded-full flex justify-between {className}"
>
	<div class="flex items-center mr-1">
		<button
            ...
            {loading
				...
				: 'bg-renobo-green/20 text-renobo-green dark:text-renobo-green-light '}
			...
			{#each visualizerData.slice().reverse() as rms}
				<div class="flex items-center h-full">
                    ...
                    {loading
							...
							: 'bg-renobo-green dark:bg-renobo-green-light  '}
	...
	<div class="flex">
        ...
        {loading ? ' text-gray-500  dark:text-gray-400  ' : ' text-renobo-green '}
       font-medium flex-1 mx-auto text-center"
		...
		<div class="flex items-center">
			...
			{:else}
				<button
					type="button"
					class="p-1.5 bg-renobo-green text-white dark:bg-renobo-green dark:text-white rounded-full"
					on:click={async () => {
